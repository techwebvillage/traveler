...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<faraday>.freeze, [">= 2.0.1", "< 3.0.0"])
    s.add_dependency(%q<faraday-multipart>.freeze, ["~> 1.0", ">= 1.0.4"])
    s.add_dependency(%q<faraday-follow_redirects>.freeze, ["~> 0.3.0"])
    s.add_dependency(%q<ostruct>.freeze, [">= 0"])
    s.add_dependency(%q<rails>.freeze, [">= 6.1.7", "< 8.0.0"])
    s.add_dependency(%q<rexml>.freeze, [">= 3.2.5", "< 4.0.0"])
    s.add_dependency(%q<actionpack>.freeze, [">= 6.1.7", "< 8.0.0"])
    s.add_dependency(%q<nokogiri>.freeze, [">= 1.12.5", "< 2.0.0"])
    s.add_dependency(%q<rake>.freeze, [">= 13.0.6", "< 14.0.0"])
    s.add_dependency(%q<sqlite3>.freeze, [">= 1.4.2", "< 2.0.0"])
    s.add_dependency(%q<rspec>.freeze, [">= 3.11.2", "< 4.0.0"])
    s.add_dependency(%q<rspec-retry>.freeze, [">= 0.6.2", "< 1.0.0"])
    s.add_dependency(%q<railties>.freeze, [">= 6.0.4", "< 8.0.0"])
    s.add_dependency(%q<rspec-rails>.freeze, [">= 6.0.4", "< 7.0.0"])
    s.add_dependency(%q<rubyzip>.freeze, [">= 2.3.0", "< 3.0.0"])
    s.add_dependency(%q<simplecov>.freeze, [">= 0.21.2", "< 1.0.0"])
  end
end
